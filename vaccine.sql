...
use vaccinedb;
create table organizations (org_id int primary key, name varchar(50), email varchar(50) unique, password varchar(100), description text(2000), logo varchar(100) default './assets/img/defaultorg.jpg');
...
create table patients (patients_id int primary key, name varchar(50), email varchar(50) unique, password varchar(100), dob varchar(15), disease varchar(50), symptoms text(1000), medical_history text(1000), phone varchar(10), address varchar(50), profile_picture varchar(100) default './assets/img/defaultpatients.jpg', vacc_id int, org_id int, foreign key(vacc_id) references vaccines(vacc_id) on delete set null, foreign key(org_id) references organizations(org_id) on delete set null);

create table reports (reports_id int primary key, result varchar(20), description varchar(100), org_id int, vacc_id int, patients_id int, foreign key(org_id) references organizations(org_id) on delete cascade, foreign key(vacc_id) references vaccines(vacc_id) on delete cascade, foreign key(patients_id) references patients(patients_id) on delete set null);
...
-- insert into organizations values(2,'GlaxoSmithKline', 'moderator@gsk.com', 'password', 'GlaxoSmithKline plc is a British multinational pharmaceutical company headquartered in Brentford, England.', '');
...
-- insert into organizations values(10,'Seqirus', 'moderator@seqirus.com', 'password', 'As part of the CSL Group, Seqirus draws on over a century of experience in influenza vaccines. From 1916 to today, CSL has been driven by the promise to save lives using the latest technologies.', 'seqi');
...
-- insert into patients values(1001, 'Alex', 'alex23@xyz.com', 'password', '01-01-1990', 'Cholera', 'None', 'Healthy Individuals', '8655660000', '81B Baker Street, London', './assets/profile/', 11, 1);
-- insert into patients values(1002, 'John', 'john97@xyz.com', 'password', '01-01-1990', 'Dengue', 'None', 'Healthy Individuals', '7856650000', 'LA City, USA', './assets/profile/', 12, 2);
-- insert into patients values(1003, 'Carry', 'carry89@xyz.com', 'password', '01-01-1990', 'Influenza', 'None', 'Healthy Individuals', '3652590000', 'Elmo Street, Canada', './assets/profile/', 13, 3);
-- insert into patients values(1004, 'Ramesh', 'ramesh01@xyz.com', 'password', '01-01-1990', 'Rabies', 'None', 'Healthy Individuals', '5613650000', ' Mumbai, India', './assets/profile/', 14, 4);
-- insert into patients values(1005, 'Suresh', 'suresh99@xyz.com', 'password', '01-01-1990', 'Chickenpox', 'None', 'Healthy Individuals', '7816320000', 'Punjab, India', './assets/profile/', 15, 5);
-- insert into patients values(1006, 'Rahul', 'rahul55@xyz.com', 'password', '01-01-1990', 'Japanese Encephalitis', 'None', 'Healthy Individuals', '7526650000', 'Delhi, India', './assets/profile/', 16, 6);
-- insert into patients values(1007, 'Rohan', 'rohan66@xyz.com', 'password', '01-01-1990', 'Measles', 'None', 'Healthy Individuals', '8961450000', 'Pune, India', './assets/profile/', 17, 7);
-- insert into patients values(1008, 'Sameer', 'sameer69@xyz.com', 'password', '01-01-1990', 'Q Fever', 'None', 'Healthy Individuals', '9872350000', 'Haryana, India', './assets/profile/', 18, 8);
-- insert into patients values(1009, 'Vicky', 'vicky10@xyz.com', 'password', '01-01-1990', 'Tuberculosis', 'None', 'Healthy Individuals', '6587450000', ' Goa, India', './assets/profile/', 19, 9);
-- insert into patients values(1010, 'Rehan', 'rehan87@xyz.com', 'password', '01-01-1990', 'Typhoid Fever', 'None', 'Healthy Individuals', '3142650000', 'Vizag, India',  './assets/profile/', 20, 10);
